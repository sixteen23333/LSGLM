...
#CUDA_VISIBLE_DEVICES=0 python home/Graph-Bert-master/script_1_preprocess.py
...
if 1:
    ...
    result_obj.result_destination_folder_path = 'home/Graph-Bert-master/result/WL/'
...
if 1:
    for k in [5]:
        ...
        result_obj = ResultSaving()
        result_obj.result_destination_folder_path = 'home/Graph-Bert-master/result/Batch/'
...
if 1:
    for k in [5]:
        ...
        result_obj = ResultSaving()
        result_obj.result_destination_folder_path = 'home/Graph-Bert-master/result/Hop/'
